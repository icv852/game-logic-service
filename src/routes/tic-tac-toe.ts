...
import { ApplyMoveSchema } from "../schemas/tic-tac-toe.js"
...
ticTacToeRouter.post("/apply-move", async (ctx: Context) => await handleHttpRequest(ctx, ctx.request.body, ApplyMoveSchema, data => applyMove(data)))
